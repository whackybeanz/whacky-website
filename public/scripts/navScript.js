$(".toggle-mode").on("click", function() {
	...
	if(modeType === "dark-mode") {
		$(`body, .sidebar, .single-info-page, .modal, 
			.table-bordered, .form-control, .radio-select, .job-choice-div`).addClass("dark-mode");
		...
		$(`body, .sidebar, .single-info-page, .modal,
			.table-bordered, .form-control, .radio-select, .job-choice-div`).removeClass("dark-mode");
