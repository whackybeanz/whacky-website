...
function updateMultipliers(categoryNum, expBuffValue, isAddStack, itemType = undefined) {
    ...
    document.getElementById("total-value").textContent = `x${totalMultiplier.toFixed(2)}`;
    document.getElementById("step-2-quick-ref-num").textContent = totalMultiplier.toFixed(2);
}
